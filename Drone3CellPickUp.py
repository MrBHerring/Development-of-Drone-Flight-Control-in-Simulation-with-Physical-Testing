...
def run_drone_altitude_thread(drone_name, target_point_name):
    ...
    subprocess.call(["python", "C:\\Users\\frost\\Desktop\\airsim_api\\AirSim\\PythonClient\\multirotor\\Drone3CarryFly.py", drone_name, target_point_name])
    drone_altitude_thread_running = False
    global x
    x = "Done"
...
def move_solar_cell(solar_cell_name, solar_cell_pose, solar_cell_position, current_drone, current_point):
    ...
    while True:
        ...
        drone_position = client.getMultirotorState(vehicle_name="Drone3").kinematics_estimated.position
...
time.sleep(2)
current_solar = "SolarCells2_10"
current_drone = "Drone3"
current_point = "SolarPoint2"
print(current_solar)
