...
#time.sleep(40)
client.takeoffAsync(vehicle_name="Drone6")
...
def run_drone_altitude_thread(drone_name, target_point_name):
    ...
    subprocess.call(["python", "C:\\Users\\frost\\Desktop\\airsim_api\\AirSim\\PythonClient\\multirotor\\Drone6CarryFly.py", drone_name, target_point_name])
    drone_altitude_thread_running = False
    global x
    x = "Done"
...
def move_solar_cell(solar_cell_name, solar_cell_pose, solar_cell_position, current_drone, current_point):
    ...
    while True:
        ...
        drone_position = client.getMultirotorState(vehicle_name="Drone6").kinematics_estimated.position
        drone_x = drone_position.x_val + 6
...
time.sleep(2)
current_solar = "SolarCells_2"
current_drone = "Drone6"
current_point = "SolarPoint"
print(current_solar)
