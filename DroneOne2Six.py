...
def flytocell():
    ...
    f1 = client.moveToPositionAsync(cell_center_x + 1, cell_center_y + 1, cell_center_z - 1, velocity=2,
                                    vehicle_name="Drone1")
    ...
    f2 = client.moveToPositionAsync(cell_center_x - 1, cell_center_y + 1, cell_center_z - 1, velocity=2,
                                    vehicle_name="Drone2")
    ...
    f3 = client.moveToPositionAsync(cell_center_x - 3, cell_center_y + 1, cell_center_z - 0, velocity=2,
                                    vehicle_name="Drone3")
    ...
    f4 = client.moveToPositionAsync(cell_center_x + 2, cell_center_y + 1, cell_center_z - 0, velocity=2,
                                    vehicle_name="Drone4")
    ...
    f5 = client.moveToPositionAsync(cell_center_x - 1, cell_center_y + 1, cell_center_z - 0, velocity=2,
                                    vehicle_name="Drone5")
    print("Reached Solar Cell 3. Hovering.")

    time.sleep(2)

    # Retrieve the pose of SolarCell
    solar_cell_name = "SolarCells_2"
    solar_cell_pose = client.simGetObjectPose(solar_cell_name)
    if solar_cell_pose.position != (None, None, None):
        # Do something with solar cell pose
        pass
    ...
    cell_center_z = (solar_cell_location.z_val - cell_width / 2) - 4
    # Move the drone to Solar Cell 5
    print(f"Moving to Solar Cell at ({cell_center_x}, {cell_center_y}, {cell_center_z})")

    f6 = client.moveToPositionAsync(cell_center_x - 3, cell_center_y + 1, cell_center_z - 0, velocity=2,
                                    vehicle_name="Drone6")
    print("Reached Solar Cell. Hovering.")
    ...
    a6 = client.landAsync(vehicle_name="Drone6")
...
def drone6_control():
    subprocess.call(["python", "C:\\Users\\frost\\Desktop\\airsim_api\\AirSim\\PythonClient\\multirotor\\Drone6CellPickUp.py"])
...
t6 = threading.Thread(target=drone6_control)
