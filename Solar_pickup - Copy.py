...
while True:
    ...
    if drone_z <= 5:
        #reposition drone to certain elevation
        #collision
...
While True:
     (mimic location)
If drone_position.z_val() == 5:   # anytime it gets close to the ground, it moves back up
                 move. drone_position.z_val +=1
       If (keyboard input=='esc'):
            drops solar cell on the current (x,y) (z stay constant)
     break
