...
def run_drone_altitude_thread(drone_name, target_point_name):
    ...
    subprocess.call(["python", "C:\\Users\\frost\\Desktop\\airsim_api\\AirSim\\PythonClient\\multirotor\\Drone2CarryFly.py", drone_name, target_point_name])
    drone_altitude_thread_running = False
    global x
    x = "Done"
...
def move_solar_cell(solar_cell_name, solar_cell_pose, solar_cell_position, current_drone, current_point):
    ...
    while True:
        ...
        drone_position = client.getMultirotorState(vehicle_name="Drone2").kinematics_estimated.position
